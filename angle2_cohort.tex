...
report (the sector's collective blind spots). %LI: is it blind spot or just not relevant? not same right?
...
the EU-market focus.
Table~\ref{tab:cohort-r} summarises the cohort. %LI: ensure that table appears here and not somewhere else please!
\begin{table}[htbp]
\centering
...
Profand     & Spain    & Wild + aquaculture & GRI            & 38 & 54\% \\
...
S1--S4, G1) as set out by EFRAG in the ESRS delegated act. %LI: source?
Beginning from this
...
\nameref{cohort-shape} section), %LI: not true - we excluded the ones not reported in figure? or is it not figure you're refering to?
26 by at least five of the six, and 13 by all six.
...
core, and its blind spots%LI: again blind spot right word?
...
backbone. %LI: repetition no - really necessary?
