...
requirements dropped and none added (Figure~\ref{fig:p1-year}). These are changes
in what the indexes carry, and not necessarily in what the firms disclose. Nomad
Foods' single decline illustrates the distinction: E1-9 was reached in 2024
through GRI 201-2, indexed to the firm's TCFD statement, and the 2025 index no
longer carries that disclosure - yet the TCFD statement itself is still published
and linked from the 2025 report. The measurement limitation of Section~5.3
therefore applies to the year-over-year reading as much as to the levels. With only
