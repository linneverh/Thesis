...
--- it is not an assessment of whether any firm's sustainability performance,
...
from the coverage numbers below.
...
published GRI-ESRS interoperability mapping (GRI \& EFRAG, 2024) and adjudicated case by
...
\nameref{cohort-shape} section), 26 by at least five of the six, and 13 by all six.
...
core, and its blind spots. The per-standard version of this same frontier - what
