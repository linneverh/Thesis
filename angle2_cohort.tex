...
Nomad Foods & UK       & Diversified (multi-species)  & GRI              & 42 & 60\% \\
Profand     & Spain    & Integrated (wild+aqua)       & GRI              & 38 & 54\% \\
Espersen    & Denmark  & Diversified (multi-species)  & ESRS             & 34 & 49\% \\
...
(Figure~\ref{fig:p1-core-by-model}).
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.75\linewidth]{phase1/p1_core_by_model.pdf}
\caption{The 13 universal-core disclosure requirements, by sourcing-model
group. All six cohort firms are processors; the four groups differ only in
what and how they source (wild-capture, aquaculture, integrated
wild-plus-aquaculture, or diversified multi-species). Each cell is the
number of companies within that group reporting the DR; all 13 requirements
are reported by at least one company in every group.}
\label{fig:p1-core-by-model}
\end{figure}
