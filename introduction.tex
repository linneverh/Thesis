...
The consequence is that every new demand arrives as a shock. Because little or no
reusable capability was built, each regulation or customer request triggers a
fresh scramble, and the firm stays a step behind: mostly catching up to the last
