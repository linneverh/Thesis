...
demand, rarely prepared for the next - the reactive posture developed fully in
Chapter~3 (Section~3.2). Two licences are at stake at once, the
...
and finance providers, and a response driven by requests they had no shared
process to answer at once.

Seafood is a case, however, not the point. The same structure, many actors,
overlapping underlying data, resource-limited firms, recurs across
...
Step~1 (Chapter~5) scans the \emph{ecosystem}: the full landscape of
...
mandatory ESRS as a common reference frame. Step~2 (Chapter~6) scans the
...
every mature firm reports. Step~3 (Chapter~7) \emph{crosses the two}: mapping
...
Figure~\ref{fig:methodology-overview} summarises the four steps. Chapter~2
states the research questions and intended contributions; Chapter~3 reviews
the literature and develops the conceptual framework (the reactive-proactive
distinction, stakeholder pressure and legitimacy); Chapter~4 sets out the
shared research design. Chapter~8 draws out the implications for seafood
