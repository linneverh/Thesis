...
illustrating the format this validation step would use, for a profile within
the scoped parameters (mixed wild-plus-aquaculture sourcing, sub-250
employees) rather than for a specific named firm: given a firm's production
profile, it returns a ranked Stage-1 build-first set --- here eight themes
--- and states plainly how much of the demand environment building them
answers, so a firm sees not just \emph{what} to build but \emph{why that
subset} before anything else.
