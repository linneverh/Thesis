...
Matrix\_\allowbreak v17.xlsx}, sheet ``Coverage matrix''): topic/datapoint rows
against scored-instrument columns, coloured by score (0/1/2). Shows the first 30
of 311 rows and 15 of the 31 scored instrument columns (Tier~1--2); the full
...
begin from the instruments catalogued in the ecosystem (Chapter~4), which is
...
% reconciled figures from Chapters 4-6; state them here once confirmed final.
