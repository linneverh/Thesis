...
below - each instrument therefore also carries a status - whether it is \emph{scored}, held out as the CSRD/ESRS \emph{baseline}
...
schemes rather than demanding anything of the processor).
