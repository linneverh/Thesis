...
% RESOLVED (2026-07-24): Mitchell, Agle & Wood (1997) added to references.tex.
% =====================================================================

\subsection{2.1 Literature review}\label{literature-review}
...
\textbf{SMEs and the proportionality problem.} Another strand documents the
...
specifically (Tugliani, Guareschi \& Arfini, 2026). What this strand establishes
...
The thesis draws these together in its conceptual framework (Sections~2.2--2.4).
...
of a single resource-constrained firm trying to answer all of them at once.
...
and firm, in a way that tells a resource-constrained SME which disclosure topics, if
